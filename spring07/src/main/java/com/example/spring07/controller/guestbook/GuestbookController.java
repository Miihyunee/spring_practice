package com.example.spring07.controller.guestbook;
...
import com.example.spring07.model.guestbook.GuestbookDAO;
import com.example.spring07.model.guestbook.GuestbookDTO;
...
public class GuestbookController {
	...
	public String insert(@RequestParam(name = "name") String name, @RequestParam(name = "email") String email,
	...
	public String update(@RequestParam(name = "_id") String _id, @ModelAttribute GuestbookDTO dto) {
		dto.set_id(_id);
