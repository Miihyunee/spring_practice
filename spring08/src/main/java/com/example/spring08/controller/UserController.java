...
public class UserController {
	...
	public String insert(@RequestParam(name="userid") String userid,@RequestParam(name="passwd")String passwd, @RequestParam(name="name")String name, @RequestParam(name="authority")String authority) {
		Map<String, Object> map = new HashMap<>();
		map.put("userid", userid);
		String pwd = pwdEncoder.encode(passwd); // 암호화
		map.put("passwd", pwd);
		map.put("name", name);
